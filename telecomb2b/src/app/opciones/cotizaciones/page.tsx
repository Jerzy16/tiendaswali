    ...
    <div className="space-y-6">
      ...
      {nuevaCotizacion && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center transition-opacity duration-300">
          <div className="border rounded-2xl p-6 w-full max-w-2xl mx-4 shadow-2xl" style={{backgroundColor: C.bgCard, borderColor: C.border, boxShadow: '0 20px 40px rgba(0,0,0,0.3)'}}>
            <div className="flex justify-between items-center mb-6">
              ...
              >
                <XCircle size={24} style={{color: C.textSecondary}} />
              </button>
            </div>
